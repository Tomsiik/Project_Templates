...
void I2C_SetSlaveAddress(I2C_TypeDef *I2C, uint8_t address) {
...
void I2C_InitConfig(I2C_TypeDef *I2C) {
...
uint8_t I2C_ReadByte(I2C_TypeDef *I2C) {
...
I2C_result	I2C_SendData(I2C_TypeDef *I2C, uint8_t addr, uint8_t data[],uint8_t size) {
	LL_I2C_EnableAutoEndMode(I2C);
...
I2C_result I2C_ReadData(I2C_TypeDef *I2C, uint8_t addr, uint8_t data[],
		uint8_t size) {
	LL_I2C_EnableAutoEndMode(I2C);
 ...
 */
I2C_result I2C_SendOneByte(I2C_TypeDef *I2C, uint8_t addr, uint8_t data) {
	LL_I2C_EnableAutoEndMode(I2C);
	LL_I2C_SetTransferRequest(I2C, LL_I2C_REQUEST_WRITE);
	I2C_SetSlaveAddress(I2C, addr);
...
uint8_t I2C_ReadOneByte(I2C_TypeDef *I2C, uint8_t addr) {
	LL_I2C_EnableAutoEndMode(I2C);
	LL_I2C_SetTransferRequest(I2C, LL_I2C_REQUEST_READ);
	I2C_SetSlaveAddress(I2C, addr);
	LL_I2C_SetTransferSize(I2C, 1);
	I2C_Start(I2C);
	return I2C_ReadByte(I2C);
	LL_I2C_ClearFlag_STOP(I2C);
